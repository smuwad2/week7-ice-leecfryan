...
export default { 
    data() {
        return {
            ...
            myHealth: 100,
            monsterHealth: 100,
            statusList: [{ class: "text-dark", text: "Game hasn't started." }],
    ...
    methods: {
        ...
        start() {
            ...
            this.statusList = [
                { class: "text-dark", text: "Game has started" },
            ];
        },
        ...
        doAttack(special) {
            ...
            var specialTxt = special ? "(special)" : "";
...
<template>
    <div class="container text-center">
        ...
        <div class="row pb-3">
            ...
            <div class="col-sm-3">
                ...
                <div class="progress my-progress">
                    <div class="progress-bar bg-success" :style="{ width: Math.max(0, myHealth) + '%' }">
                        {{ myHealth }}%
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="progress my-progress">
                    <div class="progress-bar bg-success" :style="{ width: Math.max(0, monsterHealth) + '%' }">
                        {{ monsterHealth }}%
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center p-3 border" v-else>
            <div class="col-sm-12">
                <template v-for="details in buttonDetails" :key="details.action">
        ...
        <div class="row border mt-3 p-3">
            <div class="col-sm-12 text-start">
                <p v-for="status in reversestatusList" :key="status.text + Math.random()" :class="status.class">{{ status.text }}</p>
            </div>
        </div>
    </div>
</template>
